...
export const LoginModal: React.FC<LoginModalProps> = ({
  ...
  const handleGoogleStudentLogin = async () => {
    ...
    try {
      ...
      console.error('Google Student Sign-In error:', err);
      setGoogleError(err?.message || 'تعذر تسجيل الدخول بحساب Google. يرجى التأكد من السماح بالنوافذ المنبثقة.');
    } finally {
        ...
        {activeTab === 'login' && (
          <div className="space-y-4">
            ...
            <div>
              ...
              {googleError && (
                <div className="mt-2.5 p-2.5 rounded-xl bg-red-500/20 border border-red-500/40 text-red-200 text-xs flex items-center gap-2">
            ...
            <div className="flex items-center gap-3 my-2">
              <div className="h-px flex-1 bg-emerald-700/60" />
              <span className="text-xs text-emerald-300/80 font-bold">أو الدخول اليدوي للمشرفين والطلاب</span>
              <div className="h-px flex-1 bg-emerald-700/60" />
            </div>
